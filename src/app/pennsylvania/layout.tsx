...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Pennsylvania Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/pennsylvania", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Pennsylvania Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/pennsylvania" },
};
