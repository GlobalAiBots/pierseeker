...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Louisiana Fishing Piers — PierSeeker", url: "https://pierseeker.com/louisiana", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Louisiana Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/louisiana" },
};
