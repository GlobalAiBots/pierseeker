...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Missouri Fishing Piers — PierSeeker", url: "https://pierseeker.com/missouri", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Missouri Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/missouri" },
};
