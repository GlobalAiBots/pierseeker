...
export const metadata: Metadata = {
  title: "CLETUS AI — 24/7 AI Chat & Voice Agent for Any Business | PierSeeker",
  ...
  openGraph: { title: "CLETUS AI — 24/7 Chat & Voice Agent for Any Business", url: "https://www.pierseeker.com/for-businesses", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "CLETUS AI for Your Business | PierSeeker" },
    ...
    <div>
      ...
      <section className="px-4 pt-8">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Get Featured on PierSeeker</h2>
              <p className="text-white/90 text-sm md:text-base">
                Priority placement on state and city pages. Photo gallery, customer message form, and monthly performance report &mdash; $49.95/mo. Cancel anytime.
              </p>
            </div>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Run a pier-adjacent business? Get Featured.</h2>
              <p className="text-white/90 text-sm md:text-base">
