...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Maine Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/maine", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Maine Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/maine" },
};
