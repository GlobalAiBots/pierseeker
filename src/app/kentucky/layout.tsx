...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Kentucky Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/kentucky", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Kentucky Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/kentucky" },
};
