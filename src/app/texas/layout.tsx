...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Texas Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/texas", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Texas Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/texas" },
};
