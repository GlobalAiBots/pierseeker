...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Washington Fishing Piers — PierSeeker", url: "https://pierseeker.com/washington", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Washington Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/washington" },
};
