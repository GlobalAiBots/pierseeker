...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Florida Fishing Piers — PierSeeker", url: "https://pierseeker.com/florida", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Florida Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/florida" },
};
