...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Oregon Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/oregon", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Oregon Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/oregon" },
};
