...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Montana Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/montana", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Montana Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/montana" },
};
