...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Arkansas Fishing Piers — PierSeeker", url: "https://pierseeker.com/arkansas", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Arkansas Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/arkansas" },
};
