...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New York Fishing Piers — PierSeeker", url: "https://pierseeker.com/new-york", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "New York Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/new-york" },
};
