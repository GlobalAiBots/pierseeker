...
export const metadata: Metadata = {
  ...
  openGraph: { title: "North Carolina Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/north-carolina", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "North Carolina Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/north-carolina" },
};
