...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Connecticut Fishing Piers — PierSeeker", url: "https://pierseeker.com/connecticut", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Connecticut Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/connecticut" },
};
