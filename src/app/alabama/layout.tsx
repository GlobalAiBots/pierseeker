...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Alabama Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/alabama", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Alabama Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/alabama" },
};
