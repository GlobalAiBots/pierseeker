...
export const metadata: Metadata = {
  ...
  openGraph: { title: "South Dakota Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/south-dakota", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "South Dakota Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/south-dakota" },
};
