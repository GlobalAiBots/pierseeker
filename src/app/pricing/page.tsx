...
export const metadata: Metadata = {
  title: "Pricing — Free & Featured Listings | PierSeeker",
  description: "Compare Free and Featured listings for fishing piers on PierSeeker. Featured at $49.95/mo includes priority placement, photos, customer messages, and monthly reports.",
  alternates: { canonical: "https://www.pierseeker.com/pricing" },
};
...
export default function PricingPage() {
  return (
    <main className="max-w-5xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 text-lg max-w-2xl mb-10">Every pier on PierSeeker gets a free listing. Upgrade to Featured for priority placement and lead-generation tools &mdash; ideal for bait shops, charter operators, and tackle stores near fishing piers.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm flex flex-col">
          ...
          <p className="text-gray-500 text-sm mb-6">Default for every pier we&apos;ve indexed.</p>
      ...
      <section className="mt-12">
        ...
        <div className="space-y-3">
          <details className="bg-white border border-gray-200 rounded-xl p-5">
            ...
            <p className="mt-2 text-gray-600 text-sm">Your listing appears at the top of its state and city pages with a &#11088; Featured badge. On listing cards, Featured listings get larger presentation and a priority slot above the organic list.</p>
          </details>
          <details className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <details className="bg-white border border-gray-200 rounded-xl p-5">
            <summary className="cursor-pointer font-semibold text-charcoal">What if my pier or business isn&apos;t listed yet?</summary>
