...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Idaho Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/idaho", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Idaho Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/idaho" },
};
