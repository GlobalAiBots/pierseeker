...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Kansas Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/kansas", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Kansas Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/kansas" },
};
