...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Georgia Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/georgia", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Georgia Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/georgia" },
};
