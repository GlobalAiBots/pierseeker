...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Colorado Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/colorado", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Colorado Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/colorado" },
};
