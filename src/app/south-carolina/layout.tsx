...
export const metadata: Metadata = {
  ...
  openGraph: { title: "South Carolina Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/south-carolina", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "South Carolina Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/south-carolina" },
};
