...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Massachusetts Fishing Piers — PierSeeker", url: "https://pierseeker.com/massachusetts", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Massachusetts Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/massachusetts" },
};
