...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Hampshire Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/new-hampshire", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "New Hampshire Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/new-hampshire" },
};
