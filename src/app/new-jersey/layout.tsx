...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Jersey Fishing Piers — PierSeeker", url: "https://pierseeker.com/new-jersey", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "New Jersey Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/new-jersey" },
};
