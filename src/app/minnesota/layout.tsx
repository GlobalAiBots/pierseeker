...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Minnesota Fishing Piers — PierSeeker", url: "https://pierseeker.com/minnesota", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Minnesota Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/minnesota" },
};
