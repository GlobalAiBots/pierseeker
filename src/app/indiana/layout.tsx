...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Indiana Fishing Piers — PierSeeker", url: "https://pierseeker.com/indiana", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Indiana Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/indiana" },
};
