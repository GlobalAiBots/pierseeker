...
export const metadata: Metadata = {
  ...
  openGraph: { title: "West Virginia Fishing Piers — PierSeeker", url: "https://pierseeker.com/west-virginia", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "West Virginia Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/west-virginia" },
};
