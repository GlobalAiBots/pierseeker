...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Arizona Fishing Piers — PierSeeker", url: "https://pierseeker.com/arizona", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Arizona Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/arizona" },
};
