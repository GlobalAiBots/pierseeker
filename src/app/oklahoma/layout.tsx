...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Oklahoma Fishing Piers — PierSeeker", url: "https://pierseeker.com/oklahoma", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Oklahoma Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/oklahoma" },
};
