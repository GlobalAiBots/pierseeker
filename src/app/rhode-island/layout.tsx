...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Rhode Island Fishing Piers — PierSeeker", url: "https://pierseeker.com/rhode-island", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Rhode Island Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/rhode-island" },
};
