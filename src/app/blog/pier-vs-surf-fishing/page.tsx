  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <p>
          Surf fishing demands more specialized equipment. You need a 9 to 12-foot rod to launch heavy rigs past the breakers, and the reel needs to hold plenty of line because your casts can exceed 100 yards. Pyramid sinkers in 3 to 6 ounces are necessary to hold bottom in the surf current. You need sand spikes to hold your rods, a cart to haul everything across the sand, and potentially chest waders to wade out and cast past the first sandbar. The learning curve for surf casting is steeper than pier fishing.
        </p>

        <h2 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-4">Fighting and Landing Fish</h2>
        <p>
          Landing a fish from a pier presents unique challenges. When you hook a large fish from a pier, you are elevated 15 to 30 feet above the water, which means you cannot simply reel the fish to shore. You need a pier net or bridge gaff to lift the fish up, and you often need the help of a nearby angler to handle the net while you fight the fish. Big fish can also wrap around pilings and break off. On the positive side, the elevated position gives you leverage on the fish and the ability to see the fight unfold below you.
        </p>
        <p>
