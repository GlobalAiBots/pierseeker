  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong className="text-charcoal">Glow-in-the-dark lures:</strong> Jigheads and soft plastics with glow paint or built-in glow sticks are highly effective at night. Charge them with your headlamp before casting to maximize their glow time in the water.</li>
          <li><strong className="text-charcoal">Light-tip rod indicators:</strong> Clip-on LED rod tip lights or glow sticks attached to your rod tip with electrical tape let you see your rod tip clearly in the dark. When the tip dips, you know you have a bite.</li>
          <li><strong className="text-charcoal">Headlamp with red light mode:</strong> A headlamp is essential for baiting hooks, tying knots, and unhooking fish. Use the red light mode whenever possible. Red light preserves your night vision so you can see the water and your rod tips without the white-light blindness that takes several minutes to recover from.</li>
