    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong className="text-charcoal">Rod:</strong> A 7-foot medium-action spinning rod (<a href="https://www.amazon.com/s?k=7+foot+medium+spinning+rod&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) is the most versatile choice. It handles everything from small panfish to mid-size game fish and is easy to cast from an elevated platform like a pier.</li>
          <li><strong className="text-charcoal">Reel:</strong> A 3000-size spinning reel (<a href="https://www.amazon.com/s?k=3000+spinning+reel&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) is the sweet spot for pier fishing. It holds enough line to handle longer runs from bigger fish but is not so heavy that your arm gets tired after an hour.</li>
          ...
          <li><strong className="text-charcoal">Rigs:</strong> Learn two rigs and you are covered for 90 percent of pier fishing situations. A bottom rig (also called a fish-finder rig) with a sliding sinker and a circle hook (<a href="https://www.amazon.com/s?k=circle+hooks+saltwater&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) puts your bait on the bottom where many species feed. A float rig (bobber and hook) suspends your bait at whatever depth you choose and gives you a visual strike indicator.</li>
        </ul>
