    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong className="text-charcoal">Shrimp:</strong> Fresh or frozen shrimp is the single most versatile pier bait in saltwater. Redfish, snook, flounder, sheepshead, pompano, and dozens of other species eat shrimp. Thread a whole shrimp onto a circle hook (<a href="https://www.amazon.com/s?k=circle+hooks+saltwater&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) through the tail, or peel and cut it for smaller fish. If you only bring one bait, make it shrimp.</li>
