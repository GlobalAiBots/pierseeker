  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <p>
          The beauty of pier fishing is that you can start with minimal gear. A medium spinning rod and reel combo (<a href="https://www.amazon.com/s?k=7+foot+medium+spinning+rod+reel+combo&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) in the 7-foot range is the most versatile setup for pier fishing. Spool it with 15-20 pound braided line and you will be able to handle most species you encounter. Beyond the rod, you need a small tackle box (<a href="https://www.amazon.com/s?k=tackle+box+saltwater&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) with hooks, sinkers, a few lures, and a pair of pliers. Bring a 5-gallon bucket to carry your gear and sit on, a cooler with ice for your catch, sunscreen, and a hat. Many piers have bait shops on site where you can buy live shrimp, cut bait, or frozen squid, so you do not necessarily need to bring your own bait.
        </p>
        ...
        <p>
          The most common pier fishing technique is bottom fishing with a simple rig. Tie a two-ounce pyramid sinker (<a href="https://www.amazon.com/s?k=pyramid+sinker+2+oz&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) to the end of your line, then attach a hook on a dropper loop about 12 inches above the weight. Bait the hook with shrimp, squid, or cut bait, cast it out, and let it settle on the bottom. Place your rod in a rod holder or prop it against the rail and wait for a bite. When the rod tip starts bouncing or the line moves, reel in the slack and set the hook with a firm upward sweep.
        </p>
        <p>
