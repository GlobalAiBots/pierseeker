    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong className="text-charcoal">Cooler with ice:</strong> Keep your catch fresh and your drinks cold. A small soft-sided cooler (<a href="https://www.amazon.com/s?k=soft+sided+cooler+fishing&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) is easier to carry on a pier than a full-size hard cooler.</li>
          ...
          <li><strong className="text-charcoal">Fillet knife:</strong> If you plan to clean your catch at the pier cleaning station, bring a sharp fillet knife (<a href="https://www.amazon.com/s?k=fillet+knife+saltwater+fish&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>). A dull knife is more dangerous than a sharp one.</li>
          ...
          <li><strong className="text-charcoal">Sunscreen, hat, and sunglasses:</strong> Piers offer zero shade. Polarized sunglasses (<a href="https://www.amazon.com/s?k=polarized+fishing+sunglasses&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) cut glare on the water and help you spot fish below the surface.</li>
          <li><strong className="text-charcoal">Pier cart or wagon:</strong> If you are bringing multiple rods, a cooler, and a tackle box, a folding pier cart (<a href="https://www.amazon.com/s?k=folding+fishing+cart+pier&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) saves you from making multiple trips back and forth from the parking lot.</li>
