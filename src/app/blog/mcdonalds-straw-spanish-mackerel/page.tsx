      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <div className="bg-coral/5 border border-coral/10 rounded-xl p-5">
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3"><span className="text-coral font-bold">&#10003;</span> <span><strong className="text-charcoal">Bring a wire leader for kings.</strong> If king mackerel are around, they&apos;ll hit your straw rig too &mdash; and bite through mono instantly. Have a wire leader (<a href="https://www.amazon.com/s?k=wire+leader+king+mackerel&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) ready to swap on.</span></li>
            ...
            <li className="flex items-start gap-3"><span className="text-coral font-bold">&#10003;</span> <span><strong className="text-charcoal">Ice your catch immediately.</strong> Spanish mackerel are oily fish that spoil fast in the heat. Bring a cooler (<a href="https://www.amazon.com/s?k=fishing+cooler&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-ocean hover:underline font-semibold">Our Pick on Amazon</a>) with ice and bleed the fish as soon as you land them.</span></li>
          </ul>
        </div>
