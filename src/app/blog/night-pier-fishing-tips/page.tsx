    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong className="text-charcoal">Headlamp with red light mode:</strong> A headlamp keeps your hands free for rigging, baiting, and handling fish. Choose one with a red light option &mdash; red light preserves your night vision and doesn&apos;t spook fish in the water below. White light blasts away your dark adaptation and can take 20 minutes to fully recover.</li>
          <li><strong className="text-charcoal">Glow sticks or LED rod tip lights:</strong> Clip a small glow stick or LED light to your rod tip so you can see strikes in the dark. This is especially important when fishing multiple rods &mdash; you need to know which rod is getting hit without shining a light on every tip constantly.</li>
          ...
          <li><strong className="text-charcoal">Landing net or pier gaff:</strong> Landing fish at night is trickier because visibility is reduced. A long-handled pier net makes it safer and more efficient, especially for fish with sharp gill plates or teeth.</li>
