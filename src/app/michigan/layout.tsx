...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Michigan Fishing Piers — PierSeeker", url: "https://pierseeker.com/michigan", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Michigan Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/michigan" },
};
