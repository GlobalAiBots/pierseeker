...
export default function CaliforniaPage() {
  ...
  return (
    <div>
      ...
      <PierList piers={stPiers} stateName="California" />

      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="font-[Cabin] text-2xl font-bold text-charcoal mb-4">California Pier Fishing FAQ</h2>
        <div className="space-y-2">
          {[
            { q: "How many fishing piers are in California?", a: `PierSeeker lists ${stPiers.length}+ fishing piers across California.` },
