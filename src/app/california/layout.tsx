...
export const metadata: Metadata = {
  ...
  openGraph: { title: "California Fishing Piers — PierSeeker", url: "https://pierseeker.com/california", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "California Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://pierseeker.com/california" },
};
