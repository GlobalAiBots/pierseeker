...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Virginia Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/virginia", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Virginia Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/virginia" },
};
