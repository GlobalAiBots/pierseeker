...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Wyoming Fishing Piers — PierSeeker", url: "https://www.pierseeker.com/wyoming", siteName: "PierSeeker" },
  twitter: { card: "summary", title: "Wyoming Fishing Piers | PierSeeker" },
  alternates: { canonical: "https://www.pierseeker.com/wyoming" },
};
