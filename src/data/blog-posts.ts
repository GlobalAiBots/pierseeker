...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "pier-fishing-beginners-guide",
    ...
    description: "New to pier fishing? Learn the basics of gear, technique, etiquette, and what to expect.",
    gradient: "linear-gradient(135deg, #FF6B6B 0%, #E85555 100%)",
    icon: '<svg viewBox="0 0 80 64" fill="none"><text x="20" y="45" font-size="40">🐟</text></svg>',
  },
  {
    slug: "pier-fishing-gear-checklist",
  ...
  },
  {
    ...
    description: "Most fishing piers are free to use. Here's how to find them and what to expect.",
  ...
  },
  {
    ...
    description: "Night fishing from piers can be incredibly productive. Here's how to maximize your catch.",
